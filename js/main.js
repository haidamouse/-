...
const add=String("192.168.31.209");
const vedio_port=String("10000");
const word_port=String("9999"); 
...
var ShiPing = function (wsUrl) {
    this.init(wsUrl);
    ShiPing = this;
    return this;
}

ShiPing.prototype.init = function (wsUrl) {
    // 设置websocket  url
    this.wsUrl = wsUrl;
    /** websocket对象 */
    this.signaling = null;
...
////////////////////////////////////////////////////////////////
ShiPing.prototype.createWebsocket = function () {
    ShiPing = this;                                        ////////
    ShiPing.signaling = new WebSocket(this.wsUrl);
                                                        ////
    ShiPing.signaling.onopen = function () {
        ShiPing.onOpen();                               ////
    }                                                ////

    ShiPing.signaling.onmessage = function (ev) {        ////
        ShiPing.onMessage(ev);
    }                                               ////

    ShiPing.signaling.onerror = function (ev) {        ////
        ShiPing.onError(ev);
    }                                               ////

    ShiPing.signaling.onclose = function (ev) {        ////
        ShiPing.onClose(ev);
    }                                               ////
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
ShiPing.prototype.onOpen = function () {
    console.log("websocket open");                                                                      ////
}
ShiPing.prototype.onMessage = function (event) {                                                               ////
...
ShiPing.prototype.onError = function (event) {                                                                 ////
    console.log("onError: " + event.data);
}                                                                                                       ////

ShiPing.prototype.onClose = function (event) {                                                                 ////
    console.log("onClose -> code: " + event.code + ", reason:" + EventTarget.reason);
}                                                                                                       ////

ShiPing.prototype.sendMessage = function (message) {                                                           ////
...
ShiPing = new ShiPing("ws://"+add+":"+vedio_port);
ShiPing.createWebsocket();
...
//////文字聊天/////////////
websocket = new WebSocket("ws://"+add+":"+word_port);
